...
import com.yx.common.model.IDict;
...
public class EnumPropertyBuilderPlugin implements ModelPropertyBuilderPlugin, ExpandedParameterBuilderPlugin {
    ...
    public void apply(ModelPropertyContext context) {
        context.getBeanPropertyDefinition()
                ...
                .ifPresent(field -> {
                    com.yx.common.swagger.ApiModelPropertyEnum apiModelPropertyEnum = field.getAnnotation(com.yx.common.swagger.ApiModelPropertyEnum.class);
                    ApiModelProperty apiModelProperty = field.getAnnotation(ApiModelProperty.class);
                    if (apiModelPropertyEnum != null && apiModelProperty != null) {
                        com.yx.common.swagger.SwaggerUtils.addTo(context, this.getDescription(apiModelPropertyEnum));
                    }
                });
    }
